do
  local _ENV = _ENV
  package.preload["bitn._compat"] = function(...)
    local arg = _G.arg
...
do
  local _ENV = _ENV
  package.preload["bitn.bit16"] = function(...)
    local arg = _G.arg
    --- @module "bitn.bit16"
...
do
  local _ENV = _ENV
  package.preload["bitn.bit32"] = function(...)
    local arg = _G.arg
    --- @module "bitn.bit32"
...
do
  local _ENV = _ENV
  package.preload["bitn.bit64"] = function(...)
    local arg = _G.arg
    --- @module "bitn.bit64"
...
do
  local _ENV = _ENV
  package.preload["bitn.utils.benchmark"] = function(...)
    local arg = _G.arg
