...
1. Extract and install the `esphome_govee.c4z` driver.
1. Use the "Search" tab to find "ESPHome Govee" and add it to your project.
...
1. Select your Govee device from the list. A connection binding will be
   automatically created.
1. Go to the "Connections" tab and bind the ESPHome Govee driver to the newly
